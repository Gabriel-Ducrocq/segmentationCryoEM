...
transf = np.zeros(36,)
mask = torch.zeros((1006, 6), dtype=torch.float32, device=device)
mask[:127, 0] = 1
mask[127:323, 1] = 1
mask[323:504, 2] = 1
mask[504-819, 3] = 1
...
print("Loss", loss)
res = dual_annealing(optim_function, all_bound, args=(image, mask, model, 6), no_local_search=True, initial_temp=1000, maxiter=1000000)
